...
var googleOAuthConfig = &oauth2.Config{
	...
	RedirectURL:  "https://task10-back-grfchafkdxbxd8bb.polandcentral-01.azurewebsites.net/api/auth/google/callback",
...
var githubOAuthConfig = &oauth2.Config{
	...
	RedirectURL:  "https://task10-back-grfchafkdxbxd8bb.polandcentral-01.azurewebsites.net/api/auth/github/callback",
...
func GoogleCallback(c echo.Context) error {
	...
	token := generateJWT(user)
	return c.Redirect(http.StatusFound, "https://task10-front-c7eyc9dfhfabg4fb.polandcentral-01.azurewebsites.net/?token="+token)
}
